...
#include "SHIFT.H"
/*
При нажатии клавиши 1 клавиатуры PC предлагается ввести время и дату, ко-торые затем устанавливаются как текущие в RTC DS1307. 
При нажатии кла-виши 2 на ЖКИ стенда в первой строке выводится текущее время, во второй дата. При нажатии клавиши 3 происходит очистка ЖКИ.
